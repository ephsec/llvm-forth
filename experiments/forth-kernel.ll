...
foundDefn:
    ...
    %forthFn.ptr.int = load %cell* %forthFn.ptr.ptr
    %forthKernel.ptr = inttoptr %cell %forthFn.ptr.int to %cell*
    ...
    %returnValue.flag.ptr = getelementptr i1* %returnValue.flag.ptr.ptr,
                                          i32 0
    store %cell.ptr %forthKernel.ptr, %cell.ptr* %returnValue.addr.ptr
...
notFound:
    ...
    %returnValue.addr.ptr.nf = getelementptr %WORD.fntype* %returnValue.nf,
                                             i32 0, i32 0
    store %cell.ptr null, %cell.ptr* %returnValue.addr.ptr.nf
...
handleToken:
    ...
    %is_fnPtr_null = icmp eq %cell.ptr %forthFn.ptr, null
...
compileFn:
    ...
    call fastcc void @insertToken(%int %currHeapIdx.value, %cell.ptr %forthFn.ptr)
...
define %int @main() {
    ...
    %BEGIN = call %addr @allocate(%cell 0)
